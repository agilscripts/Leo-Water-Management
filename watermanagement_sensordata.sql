...
CREATE TABLE `sensordata` (
  ...
  `water_level` float(3,2) DEFAULT NULL,
  `temperature` float(3,2) DEFAULT NULL,
  `flow_rate` float(3,2) DEFAULT NULL,
  PRIMARY KEY (`sensor_id`),
  KEY `source_id` (`source_id`),
  CONSTRAINT `sensordata_ibfk_1` FOREIGN KEY (`source_id`) REFERENCES `watersource` (`source_id`)
